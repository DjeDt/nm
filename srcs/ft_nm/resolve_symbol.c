...
/*   Updated: 2018/11/09 19:06:17 by ddinaut          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "nm.h"

static char		resolve_type_from_section(uint8_t n_sect, t_binary *bin)
{
	uint32_t	count;
	t_section	*sect;
...
char			resolve_symbol_type(\
	uint8_t n_type, uint8_t n_sect, uint8_t n_val, t_binary *bin)
{
	char	c;
	uint8_t	type;
